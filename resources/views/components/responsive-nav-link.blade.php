...
? 'block w-full ps-3 pe-4 py-2 border-l-4 border-amber-400 dark:border-amber-600 text-start text-base font-medium
text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-900/50 focus:outline-none focus:text-amber-800
dark:focus:text-amber-200 focus:bg-amber-100 dark:focus:bg-amber-900 focus:border-amber-700 dark:focus:border-amber-300
