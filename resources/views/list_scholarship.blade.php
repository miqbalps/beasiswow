            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
                    <div class="relative h-48">
                        <img src="https://placehold.co/600x400" alt="BNI Scholarship"
                            class="w-full h-full object-cover">
                        <div class="absolute bottom-4 left-4">
                            <img src="https://placehold.jp/-16x-16.png" alt="BNI Logo"
                    ...
                    <div class="p-4 flex-grow flex flex-col">
                        ...
                        <button class="mt-4 bg-amber-500 text-white px-4 py-2 rounded-md w-full">Informasi
                            Selanjutnya</button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
                    <div class="relative h-48">
                        ...
                        <div class="absolute bottom-4 left-4">
                            <img src="https://placehold.jp/-16x-16.png" alt="JFLS Logo"
                                class="w-16 h-16 bg-white rounded-lg shadow">
                        </div>
                    </div>
                    <div class="p-4 flex-grow flex flex-col">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
                    <div class="relative h-48">
                        <img src="https://placehold.co/600x400" alt="Beasiswa Pendidikan"
                            class="w-full h-full object-cover">
                        <div class="absolute bottom-4 left-4">
                            <img src="https://placehold.jp/-16x-16.png" alt="Pendidikan Logo"
                                class="w-16 h-16 bg-white rounded-lg shadow">
                        </div>
                    </div>
                    <div class="p-4 flex-grow flex flex-col">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
                    <div class="relative h-48">
                        ...
                        <div class="absolute bottom-4 left-4">
                            <img src="https://placehold.jp/-16x-16.png" alt="RMP Logo"
                                class="w-16 h-16 bg-white rounded-lg shadow">
                        </div>
                    </div>
                    <div class="p-4 flex-grow flex flex-col">
