                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <div class="flex items-center space-x-3">
                            <div class="@if($approval->status === 'approved') bg-green-100 text-green-600
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-gray-900 dark:text-gray-100">
                                    {{ $approval->updated_at->format('d F Y H:i') }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        ...
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->nik }}</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Nama</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->name }}</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">NKK</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->nkk }}</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Tempat Lahir</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{
                            $approval->user->identity->birth_place }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Tanggal Lahir</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->birth_date
                            }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Jenis Kelamin</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->gender }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Status Pernikahan</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->married }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Agama</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->religion
                            }}</p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Nomor Telepon</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->phone }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Anak ke-</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{
                            $approval->user->identity->child_number }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Asal</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->origin }}
                        </p>
                    </div>
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Pendapatan</p>
                        <p class="font-medium text-gray-900 dark:text-gray-100">{{ $approval->user->identity->income }}
                        </p>
                    </div>
                </div>
            </div>
